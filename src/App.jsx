...
function App() {
    ...
    const [defaultSubjectClassDuration, setDefaultSubjectClassDuration] = useState(10);
            ...
            <header className="App-header">
                ...
                <div className="flex gap-4">
                    <div className="w-5/12">
                        <SubjectListContainer defaultSubjectClassDuration={defaultSubjectClassDuration} />
                    </div>
                ...
                <div className="flex gap-4">
                    <div className="w-12/12">
                        <ProgramListContainer morningStartTime={morningStartTime} afternoonStartTime={afternoonStartTime}/>
                    </div>
                </div>
