    ...
    return (
        <div className="h-screen flex items-center justify-center">
            <div className="w-full flex flex-col md:flex-row h-full">
                ...
                <div className="w-full md:w-2/3 bg-cover bg-center h-full">
                    {/* <LandingIntro /> */}
                    <Swiper
                        modules={[Autoplay]}
                        slidesPerView={1}
                ...
                <div className="w-full md:w-1/3 flex items-center justify-center p-10">
                    <div className="w-full max-w-md px-8">
                        {/* Logo section */}
                        <div className="mb-6 flex flex-col justify-center items-center select-none">
                            <img src="/Batasan Logo.png" alt="Logo" className="h-24 w-24 mb-2" />
                            <div className="text-2xl font-bold text-center">Batasan High School Timetabling</div>
                        </div>
                        ...
                        <h2 className="text-lg font-medium mb-4 text-center text-gray-500">
