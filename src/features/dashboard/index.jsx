...
function Dashboard() {
  ...
  const [statsData, setStatsData] = useState([
    { title: 'Departments', value: '0', icon: < BuildingOfficeIcon  className="w-8 h-8" />, description: 'All active departments' },
    { title: 'Programs', value: '0', icon: <ComputerDesktopIcon className="w-8 h-8" />, description: 'Includes various courses' },
    { title: 'Ranks', value: '0', icon: <ChartBarIcon className="w-8 h-8" />, description: 'Staff hierarchy levels' },
    { title: 'Sections', value: '0', icon: <RectangleGroupIcon className="w-8 h-8" />, description: 'Different class sections' },
