...
const TeacherEdit = ({
    ...
    return (
        <div className="flex items-center justify-center">
            {/* Trigger Button */}
            <label
                htmlFor={`teacherEdit_modal_${teacher.id}`}
            ...
            <input
                type="checkbox"
                id={`teacherEdit_modal_${teacher.id}`}
                ...
                >
                    ...
                    <div className="p-6">
                        ...
                        <div className="w-1/2 flex justify-center">
                            <div className="w-5/6">
                                <div className="p-2 flex justify-center font-bold bg-gray-200 rounded-t-lg">
