...
const AdditionalScheduleForTeacher = ({
    ...
    const [schedSubject, setSchedSubject] = useState(additionalSchedsOfTeacher.subject || 0);
    const [schedDuration, setSchedDuration] = useState(additionalSchedsOfTeacher.duration || 0);
    const [schedFrequency, setSchedFrequency] = useState(additionalSchedsOfTeacher.frequency || 0);
    const [schedShown, setSchedShown] = useState(additionalSchedsOfTeacher.shown || false);
    const [schedTime, setSchedtime] = useState(additionalSchedsOfTeacher.time || 0);
    ...
    const handleSave = () => {
        ...
        document.getElementById(`add_additional_sched_modal_${viewingMode}_teacher-${teacherID}_idx-${arrayIndex}`).close();
    };

    const handleClose = () => {
        const modal = document.getElementById(`add_additional_sched_modal_${viewingMode}_teacher-${teacherID}_idx-${arrayIndex}`);
        ...
        <div className='justify-left'>
            ...
            <div className='flex flex-wrap mb-4'>
                        ...
                        <div className='flex flex-wrap gap-2 p-1 bg-gray-100'>
                            {selectedSubjects.length === 0 ? (
                                ...
                                selectedSubjects.map((subjectID) => (
                                    <div key={subjectID} className='p-1 bg-green-700 text-white rounded-lg'>
                ...
                <div className='w-1/2 flex justify-center'>
                    <div className='w-5/6'>
                        <div className='p-2 font-bold bg-gray-200 rounded-t-lg'>Grade Levels to Teach</div>
