...
const SuccessModal = ({ message, onClose }) => {
    return (
        <div className="modal modal-open flex items-center justify-center">
            <div className="modal-box flex flex-col items-center justify-center p-4">
                {' '}
                {/* Added padding */}
                <div className="lottie-animation w-48 h-48">
                    <Lottie
                        animationData={animationData} // Replace with your Lottie JSON
                        loop={false} // Ensures the animati on does not loop
                    />
                </div>
                <h2 className="font-bold text-lg text-center">{message}</h2>{' '}
                {/* Center text */}
...
const AddTeacherContainer = ({ close, reduxFunction }) => {
