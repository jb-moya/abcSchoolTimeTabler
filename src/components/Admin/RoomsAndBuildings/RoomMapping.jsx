        ...
        <>
            ...
            <div className="max-h-[60vh] overflow-scroll grid grid-cols-1 md:grid-cols-3 gap-2">
                {Array.from({ length: numberOfFloors }, (_, floorIndex) => (
                    <div
                        key={floorIndex}
                        className="border rounded-md p-2 bg-gray-50 shadow-sm"
                    >
                        ...
                        <div
                            className="overflow-y-auto rounded-md max-h-28 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200"
