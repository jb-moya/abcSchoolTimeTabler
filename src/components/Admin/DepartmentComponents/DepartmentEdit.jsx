...
const DepartmentEdit = ({
  ...
  const [selectedTeacher, setSelectedTeacher] = useState(null); // Only one teacher
  ...
  const handleSaveDepartmentEditClick = () => {
    ...
    const duplicateDepartment = Object.values(departments).find(
      (dep) =>
        dep.name.trim().toLowerCase() === editDepartmentValue.trim().toLowerCase() &&
      ...
      <div className="modal">
        <div className="modal-box relative">
          ...
          <div className="flex justify-center gap-2 mt-4">
            ...
            <button className="btn btn-error " onClick={handleCancelDepartmentEditClick}>
              Cancel
            </button>
          </div>
        </div>
