        ...
        <div className='flex items-center justify-center'>
            ...
            <div className='modal'>
                <div className='modal-box relative' style={{ width: '60%', maxWidth: 'none' }}>
                    ...
                    <h3 className='flex justify-center text-lg font-bold mb-4'>Edit Program</h3>
                    <hr className='mb-4' />
                    ...
                    {editProgramId === program.id && (
                        <div className='p-6'>
                            ...
                            <div className='flex flex-col justify-center items-center'>
                                {[7, 8, 9, 10].map((grade) => (
                                    <div
                                        ...
                                        className='mt-2 w-1/2  overflow-y-auto h-36 max-h-36 border border-base-content border-opacity-20 rounded-lg'
                                        style={{ scrollbarWidth: 'thin', scrollbarColor: '#a0aec0 #edf2f7' }} // Optional for styled scrollbars
                                    >
                                        <div
                                            className='flex bg-base-200 flex-wrap border-b border-base-content border-opacity-20'
                                            style={{
                                                position: 'sticky',
                                                top: 0,
                                                zIndex: 1,
                                        ...
                                        {editAdditionalScheds[grade].map((sched, index) => (
                                            <div
                                                key={index}
                                                className='flex flex-wrap border rounded-lg border-base-content border-opacity-20'
                                            >
                                                <button
                                                    className='w-1/12 flex items-center rounded-lg justify-center hover:text-error hover:bg-base-300'
                                                ...
                                                <div className='w-1/12 text-xs font-bold flex text-center justify-center items-center p-2 cursor-pointer'>
                                                    <button
                                                        className='rounded-lg hover:text-primary hover:bg-base-300'
                                                        onClick={() =>
                                                            document
                                                                .getElementById(
                            ...
                            <div className='flex justify-center gap-2 mt-4'>
                                ...
                                <button className='btn btn-error' onClick={initializeStates}>
                                    Reset
                                </button>
                            </div>
                        </div>
